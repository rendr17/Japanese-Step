            ...
            function: {
              ...
              parameters: {
                ...
                properties: {
                  ...
                  indonesian_translation: { type: "string", description: "Full Indonesian translation of the content_html. Translate all Japanese text to Indonesian, keeping the same structure (paragraphs, dialogue format). Do NOT include HTML tags or furigana, just plain text with line breaks." },
                },
                required: ["title", "content_html", "vocabulary", "grammar_notes", "cultural_note", "indonesian_translation"],
                additionalProperties: false,
              },
            },
          },
